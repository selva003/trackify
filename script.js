...
function checkAuth() {
    ...
    if (!currentUser && !path.includes('index.html') && !path.includes('signup.html')) {
        // Just fail safe for local dev
        if (window.location.protocol === 'file:') {
            const newPath = window.location.href.substring(0, window.location.href.lastIndexOf('/')) + '/index.html';
